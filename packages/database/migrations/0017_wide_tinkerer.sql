...
ALTER TABLE "email_outbox" ADD COLUMN "matter_id" text;--> statement-breakpoint
UPDATE "email_outbox" SET "matter_id" = "metadata"->>'matterId' WHERE "matter_id" IS NULL AND "metadata" ? 'matterId';--> statement-breakpoint
ALTER TABLE "email_outbox" ALTER COLUMN "matter_id" SET NOT NULL;--> statement-breakpoint
