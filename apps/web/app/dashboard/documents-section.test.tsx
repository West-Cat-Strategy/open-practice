...
describe("DocumentsSection", () => {
  it("renders the document-processing workbench without changing copy or classes", () => {
    ...
    expect(html).toContain(
      "Conversion review reviewed · 1800 chars · 260 words · 1 estimated pages · artifact metadata only · OP-authored metadata only · metadata only · latest decision reviewed at 2026-06-26T18:30:00.000Z · reviewer user_synthetic · 1 decision cue · decision metadata only · decision review only · decision no downstream mutation · decision no provider evidence · decision no raw OCR returned · semantic ready · 0 semantic checkpoints · semantic preflight ready · preflight same matter only · preflight metadata only · preflight body free · preflight no provider · preflight no downstream mutation · readiness reviewed · reviewed 2026-06-26T18:30:00.000Z · staff review required · terminal review · review only · no downstream mutation · no provider evidence · no raw OCR returned",
    );
  ...
  it("renders semantic review checkpoint counts and busy states", () => {
    ...
    expect(checkpointedHtml).toContain(
      "semantic ready · 1 semantic checkpoint · latest checkpoint ready for review at 2026-06-29T12:00:00.000Z · checkpoint reviewer user_synthetic · checkpoint metadata only · checkpoint review only · checkpoint no provider · checkpoint no downstream mutation · checkpoint no raw OCR returned · semantic preflight ready · preflight same matter only · preflight metadata only · preflight body free · preflight no provider · preflight no downstream mutation",
    );
  ...
  it("describes rejected conversion review readiness without exposing provider evidence", () => {
    expect(
      ...
      "rejected · artifact metadata only · OP-authored metadata only · metadata only · latest decision rejected at 2026-06-26T18:35:00.000Z · reviewer user_synthetic · 1 decision cue · decision metadata only · decision review only · decision no downstream mutation · decision no provider evidence · decision no raw OCR returned · semantic blocked · 0 semantic checkpoints · semantic preflight blocked · preflight same matter only · preflight metadata only · preflight body free · preflight no provider · preflight no downstream mutation · readiness rejected · reviewed 2026-06-26T18:35:00.000Z · staff review required · terminal review · review only · no downstream mutation · no provider evidence · no raw OCR returned",
    );
  });
});
