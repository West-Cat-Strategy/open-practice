...
- Start from a branch, never from a direct `main` push. Open a draft PR and wait for required checks.
...
- Follow `docs/development/github-maintenance.md` for GitHub automation, Dependabot, Copilot agents, and post-squash branch cleanup.
