...
describe("create-release-proof contract", () => {
  ...
  it("keeps default release commands unchanged and adds residual watch only for private pilot", () => {
    assert.equal(
  ...
  it("records private-pilot residual watch in release proof metadata", () => {
