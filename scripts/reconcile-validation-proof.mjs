...
const PATH_PATTERN =
  /(?:^|[\s`])((?:[A-Za-z0-9_.-]+\/)+[A-Za-z0-9_.-]+|(?:README|CONTRIBUTING)\.md|Dockerfile|docker-compose(?:\.[A-Za-z0-9_.-]+)?\.ya?ml|\.gitignore|\.gitleaksignore|\.dockerignore|\.env\.example|package\.json|pnpm-lock\.yaml|pnpm-workspace\.yaml|turbo\.json)(?=$|[\s`,])/g;
