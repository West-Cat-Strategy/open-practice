...
export const ROUTE_AUTHORIZATION_MANIFEST = [
  ...
  authRoute(
    ...
    "apps/api/src/routes/contacts.test.ts",
    "POST",
    "/api/contacts/:contactId/review-decisions",
    "contact",
    "update",
  ),
  ...
  authRoute(
    ...
    "apps/api/src/routes/billing.test.ts",
    "POST",
    "/api/billing/period-locks/:id/release",
    "time_entry",
    "approve",
    "derived",
  ),
  ...
  authRoute(
    ...
    "apps/api/src/routes/email.test.ts",
    "POST",
    "/api/mail/outbox/:emailId/receipt-links",
    "email",
    "create",
    "derived",
  ),
