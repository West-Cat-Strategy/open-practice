...
- Add focused tests for legal-clinic metadata DTOs, memory invoice cross-firm duplicate ids,
...
- Triage the two code-review export idempotency issues before adding more long-running export
  request flows.
- Add UI/UX assertions for public intake field-level error mapping.
