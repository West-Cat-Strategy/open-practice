...
- `packages/database/migrations/0043_calendar_scheduling_requests.sql`
...
- `pnpm migrations:check` - passed in the isolated worktree; during all-branch consolidation the
  migration was renumbered to `0043_calendar_scheduling_requests.sql` after
  `0041_document_assembly_envelopes.sql` and `0042_contact_relationship_graph.sql`.
