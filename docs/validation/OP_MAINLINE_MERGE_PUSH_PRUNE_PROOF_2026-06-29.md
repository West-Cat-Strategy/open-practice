...
Status: Published on `main` at `ac7a5992311a17bc7fb543dcde067707368bb48e` with push parity
confirmed. Clean merged lane worktrees and branches were pruned after ignored local backups were
saved under `.tmp/open-practice-prune-20260629-20260629T211826Z`.
...
| Command                                                                                                                          | Result | Notes                                                                                                                                                                                                                                                                                                      |
| -------------------------------------------------------------------------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `git fetch --prune origin`                                                                                                       | Pass   | `origin/main` remained at the expected base `0d850772d7053f38b9d139a50dff871126b2eadf` before publication.                                                                                                                                                                                                 |
| `git switch main && git merge --no-ff integrate/mainline-consolidation-20260629-active-lanes -m "Merge 2026-06-29 active lanes"` | Pass   | Created merge commit `ac7a5992311a17bc7fb543dcde067707368bb48e`.                                                                                                                                                                                                                                           |
| `git push origin main`                                                                                                           | Pass   | Published `main` from `0d850772` to `ac7a5992`.                                                                                                                                                                                                                                                            |
| `git rev-list --left-right --count main...origin/main`                                                                           | Pass   | Returned `0 0` after push.                                                                                                                                                                                                                                                                                 |
| `git status --short --branch --untracked-files=all`                                                                              | Pass   | Root worktree was clean on `main...origin/main` after push and after prune.                                                                                                                                                                                                                                |
| prune backup capture                                                                                                             | Pass   | Saved status, binary diff, cached diff, head, branch mapping, root status, and stash list under `.tmp/open-practice-prune-20260629-20260629T211826Z` before pruning.                                                                                                                                       |
| clean merged worktree prune                                                                                                      | Pass   | Removed clean sibling worktrees for calendar aging decisions, document disposition schedule profile, email template compare, mainline proof reconcile, OP-T162 readiness reasons, payment-import auth fixtures, refund/chargeback decisions, semantic readiness, and Trust Controls policy preview matrix. |
| merged branch cleanup                                                                                                            | Pass   | Deleted merged branches for those sibling worktrees plus `feat/report-export-profile-alignment-20260629` and `integrate/mainline-consolidation-20260629-active-lanes`.                                                                                                                                     |
| `git worktree list --porcelain`                                                                                                  | Pass   | Only `/Users/bryan/projects/open-practice` on `refs/heads/main` remained.                                                                                                                                                                                                                                  |
| `git branch --no-merged main`                                                                                                    | Pass   | Returned no branches.                                                                                                                                                                                                                                                                                      |
| `git stash list \| wc -l` before/after prune                                                                                     | Pass   | Stash count stayed `70`; no stashes were dropped or rewritten.                                                                                                                                                                                                                                             |

No worktree was left unpruned because of dirty residue.
