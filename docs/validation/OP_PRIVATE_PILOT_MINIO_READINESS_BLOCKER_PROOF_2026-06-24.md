...
| `pnpm selfhost:restore-drill -- --env-file docker/selfhost.example.env --allow-synthetic-example`                                       | Covered by mainline      | Mainline reconciliation keeps the readiness-remediation restore drill selector behavior alongside the MinIO residual-watch selector behavior. The direct gate is rerun in the 2026-06-24 mainline closeout before publication.                                                                                                                                |
