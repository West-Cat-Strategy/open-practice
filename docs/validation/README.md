...
new follow-up is API documentation inventory completeness for manifest entries that are currently
represented through compact docs notation, generated API inventory, route tests, or boundary gates
rather than exact per-route docs rows.
