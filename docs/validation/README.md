...
checked-in bundled MinIO restore-drill proof are locally validated, while real external HTTPS S3
operator proof remains blocked because `.env.selfhost.local` is currently only an ignored
placeholder template. The branch preserves local-only self-hosting boundaries, runtime APIs,
schemas, Compose contracts, dependency manifests, default private-pilot release-proof behavior,
residual-watch semantics, and synthetic-only proof.
...
| Artifact                                                                                                                                                           | Type                 | Use                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OP_GITLEAKS_HISTORY_FALSE_POSITIVE_TUNING_PROOF_2026-06-26.md](OP_GITLEAKS_HISTORY_FALSE_POSITIVE_TUNING_PROOF_2026-06-26.md)                                     | Security proof       | Proof for exact-fingerprint Gitleaks history tuning over reviewed synthetic test/proof fixtures, preserving tracked-secret scanner strength, GitHub secret-scanning posture, local-only evidence, and clean-room boundaries without adding broad rule/path/regex allowlists or changing runtime behavior.                                                                                                                                                                                                                           |
