...
reconcile readiness cues with structured safe reason details, safe audit metadata,
selector-driven validation, and preserved no live settlement, provider commands, raw provider
payload retention, invoice-balance mutation, reconciliation automation, refund/chargeback workflow,
