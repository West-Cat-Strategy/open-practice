...
new command, schema, migration, audit write, object deletion, retention-deadline enforcement,
legal-hold release command, raw OCR/provider payload retention, or compliance claim.
