...
| Artifact                                                                                                                             | Type                 | Use                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------ | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OP_BRANCH_CONSOLIDATION_PROOF_2026-05-26.md](OP_BRANCH_CONSOLIDATION_PROOF_2026-05-26.md)                                           | Merge proof note     | Local proof for consolidating the OP-T119 through OP-T123 operational lanes and public consultation intake lane, including the known OSS lock/index policy blocker.                          |
