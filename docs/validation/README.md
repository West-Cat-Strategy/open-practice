...
The 2026-06-28 branch-integration validation draft is recorded in
[OP_MAINLINE_MERGE_PUSH_PRUNE_PROOF_2026-06-28.md](OP_MAINLINE_MERGE_PUSH_PRUNE_PROOF_2026-06-28.md).
It tracks the in-progress closeout of provider document conversion review decisions, provider
document conversion latest-decision/history cues, OP-T162 deposit-match reviewer decisions, the
refund/chargeback review cue surface, and the adopted matter lifecycle closed/archived reopen
boundary.
Provider-status and self-host operations-readiness residue was preserved separately in targeted
stashes and is not part of this closeout. It is not final mainline publication evidence yet; selector
output, validation statuses, push parity, and branch/worktree prune evidence must be updated before
it can be treated as a mainline proof.
...
| Artifact                                                                                                                                                           | Type                    | Use                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OP_MAINLINE_MERGE_PUSH_PRUNE_PROOF_2026-06-28.md](OP_MAINLINE_MERGE_PUSH_PRUNE_PROOF_2026-06-28.md)                                                               | Draft integration proof | Draft proof for the in-progress 2026-06-28/2026-06-29 review-decision closeout, covering provider document conversion review decisions and latest-decision/history cues, OP-T162 deposit-match reviewer decisions, the adopted matter lifecycle closed/archived reopen boundary, separately preserved provider/self-host residue, selector-driven validation tracking, and remaining mainline publication/prune evidence to be recorded before final closeout.                                                                                                                                           |
