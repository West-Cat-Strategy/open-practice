...
structured task detail reads, route authorization coverage, safe audit metadata, dashboard controls,
and migration/repository/domain validation while preserving existing task CRUD, source-pair,
archive, workbench, permission, client visibility, provider, recurrence, and email boundaries.
