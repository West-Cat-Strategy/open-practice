...
| `POST /api/operational-views/definitions`                                             | Create an owner-private saved operational view definition for a permitted dashboard surface; saved matter views currently support the dashboard's matter follow-up preset family.                                                                                                                  |
