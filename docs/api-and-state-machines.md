...
| `POST /api/portal/intake-forms/:token/items/:itemId/documents/:documentId/complete`   | Public checksum completion for an intake upload item document.                                                                                                                                                                                                                                                                                                           |
...
| `POST /api/portal/external-uploads/:token/documents/:documentId/complete`             | Public token-scoped checksum and scan-state completion for a document upload intent.                                                                                                                                                                                                                                                                                     |
