...
| `GET /api/contacts/dossiers`                                                          | Read-only contact dossiers derived from visible matter-party links, active portal grants, aliases, identifiers, adverse/confidential cues, CRM taxonomy labels, display-safe contact relationship summaries, quality-review signals, and redacted conflict-check history.                                                                                         |
...
| `GET /api/billing/dashboard`                                                          | Billing dashboard payload for approved unbilled work, draft invoices, issued balances, payments, period-lock summaries, and rate-rule summaries.                                                                                                                                                                                                                  |
