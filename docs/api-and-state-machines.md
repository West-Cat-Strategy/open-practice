...
| `GET /api/tasks/workbench?matterId=`                                                  | Matter-scoped task/deadline projections, my/team counters, matter/contact queues, and focused overdue/today/upcoming/unassigned task IDs.                                                                                                                                                                                                                         |
