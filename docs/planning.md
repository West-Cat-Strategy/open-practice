...
- `packages/domain` for provider-neutral legal rules, permission checks, audit hash chains, signature and automation contracts, and trust/funds ledger validation.
