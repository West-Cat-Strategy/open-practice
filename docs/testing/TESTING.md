...
| Release readiness      | `pnpm release:local`                             | Runs dependency audits, license evidence, the full local gate, diff whitespace, and local release evidence artifact generation. |
